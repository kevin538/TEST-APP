                                        ...
                                        <div>
                                            ...
                                            <div class="form-group">
                                                <input type="text" 
                                                    ...
                                                    name="nomarticle" id="titreBug" placeholder="Nom de L'article">
                                                    @error('nomarticle')
                                        ...
                                        <div>
                                            ...
                                            <div class="form-group">
                                                <input type="number" 
                                                    ...
                                                    name="quantité" id="titreBug" placeholder="0.000">
                                                    @error('quantité')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>
                                                            {{ $message }}
                                            ...
                                            <div class="form-group">
                                                <input type="number"
                                                    class="form-control   @error('pri_ve_min') is-invalid @enderror"
                                                     name="pri_ve_min" id="titreBug" placeholder="0.000FCFA">
                                                    @error('pri_ve_min')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>
                                                            {{ $message }}
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-wd btn-success" id="submitBtn"
                                            ...
                                            <img src="{{ asset('img/loading.gif') }}" class="loader"
                                                style="height: auto; width: 1.2rem;display:none;margin-left: 0.2rem;">
